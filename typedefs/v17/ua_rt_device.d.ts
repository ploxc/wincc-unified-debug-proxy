...
interface HMIUISysFct {
  ...
  /**
   * Call a function exposed by a Control. 
   *
   * @param screenItemPath The path of the Control
   * @param functionName The name of the Control's function to be called
   * @param arguments The arguments of the function
   *
   * @returns Variant
   */
  CallFunction(screenItemPath: ( HmiScreenItemBase | string ), functionName: string, arguments?: ( any | any[] )): any;
}
...
interface HMIParameterSetTypesSysFct {
   ...
   * @param OverWrite Specifies whether an existing ParameterSet is overwritten.
   * @param OutputStatus Determines whether a status message is output after transfer.
   * @param ProcessingStatus The name of the server or system where to execute the function.
   *
   * @returns Promise
   */
